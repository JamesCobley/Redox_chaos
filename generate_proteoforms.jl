...
function display_transitions(r::Int)
    ...
    for (i, proteoform) in enumerate(proteoforms)
        ...
        println("  Allowed transitions: $(join(allowed_transitions, ", "))")  # Removed the escape character
        println("  Barred transitions: $(join(barred_transitions, ", "))")   # Removed the escape character
